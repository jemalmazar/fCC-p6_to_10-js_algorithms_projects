...
})({"f65IU":[function(require,module,exports) {
...
/* eslint import/no-unresolved: 2 */ var _handlersJs = require("./handlers.js");
if (window.innerWidth >= 1080) {
    (0, _elementsJs.tabcordionButtons)[0].setAttribute("aria-expanded", true);
    (0, _elementsJs.tabcordionButtons)[0].style.borderTop = "solid 3px black";
    (0, _elementsJs.tabcordionButtons)[0].style.borderBottom = "none";
    (0, _elementsJs.tabcordionPanels)[0].setAttribute("aria-hidden", false);
    (0, _elementsJs.tabcordionPanels)[0].style.maxHeight = `${(0, _elementsJs.tabcordionPanels)[0].scrollHeight}px`;
}
(0, _elementsJs.tabcordionButtons).forEach((button)=>button.addEventListener("click", (0, _handlersJs.handleClick)));
(0, _elementsJs.panelForms).forEach((form)=>form.addEventListener("submit", (0, _handlersJs.handleSubmit)));

},{"./elements.js":"aonE7","./handlers.js":"hCzvv"}],"aonE7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "tabcordionButtons", ()=>tabcordionButtons);
parcelHelpers.export(exports, "expandArrows", ()=>expandArrows);
parcelHelpers.export(exports, "tabcordionPanels", ()=>tabcordionPanels);
parcelHelpers.export(exports, "panelForms", ()=>panelForms);
parcelHelpers.export(exports, "resultDivs", ()=>resultDivs);
...
},{}],"hCzvv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function handleClick(e) {
    ...
    const tabPanel = (0, _elementsJs.tabcordionPanels).find((panel)=>panel.getAttribute("aria-labelledby") === id);
    ...
    (0, _elementsJs.tabcordionButtons).forEach((button)=>{
        button.setAttribute("aria-expanded", false);
        button.style = null;
    });
    // hide all panels & mark all as hidden
    (0, _elementsJs.tabcordionPanels).forEach((panel)=>{
        panel.setAttribute("aria-hidden", true);
        panel.style.maxHeight = null;
    });
    // rotate expand arrow to original state
    (0, _elementsJs.expandArrows).forEach((icon)=>icon.style.transform = null);
    if (isTabOpen === "false") {
...
function handleSubmit(e) {
    ...
    const targetDiv = (0, _elementsJs.resultDivs).find((panel)=>panel.getAttribute("aria-labelledby") === name);
    if (name === "palindrome" && e.currentTarget.palindrome.value !== "") {
        const cleanPalindrome = (0, _dompurify.sanitize)(e.currentTarget.palindrome.value, {
            FORBID_ATTR: [
                "width",
                "height",
                "style"
        ...
        if ((0, _libJs.palindrome)(cleanPalindrome) && cleanPalindrome !== "") targetDiv.innerHTML = `
                <p>
        ...
        const cleanRomanNumeral = (0, _dompurify.sanitize)(e.currentTarget.roman.value, {
            FORBID_ATTR: [
                "width",
                "height",
                "style"
        ...
        targetDiv.innerHTML = `
            <p>${(0, _libJs.convertToRoman)(cleanRomanNumeral)}</p>
        `;
    } else if (name === "caesar" && e.currentTarget.caesar.value !== "") {
        const cleanCaesar = (0, _dompurify.sanitize)(e.currentTarget.caesar.value, {
            FORBID_ATTR: [
                "width",
                "height",
                "style"
        ...
        targetDiv.innerHTML = `
            <p>${(0, _libJs.rot13)(cleanCaesar)}</p>
        `;
    } else if (name === "telephone" && e.currentTarget.telephone.value !== "") {
        const cleanPhoneNumber = (0, _dompurify.sanitize)(e.currentTarget.telephone.value, {
            FORBID_ATTR: [
                "width",
                "height",
                "style"
        ...
        if ((0, _libJs.telephoneCheck)(cleanPhoneNumber) && cleanPhoneNumber !== "") targetDiv.innerHTML = `
                <p>
                    <span class="material-symbols-outlined">check_circle</span>
                    Valid Format
                </p> 
            ...
            `;
    } else targetDiv.innerHTML = `<p>Nothing Entered</p>`;
}

},{"./elements.js":"aonE7","./lib.js":"4ZJel","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","dompurify":"9Kzno"}],"4ZJel":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "palindrome", ()=>palindrome);
parcelHelpers.export(exports, "convertToRoman", ()=>convertToRoman);
parcelHelpers.export(exports, "rot13", ()=>rot13);
parcelHelpers.export(exports, "telephoneCheck", ()=>telephoneCheck);
...
/*! @license DOMPurify 3.0.1 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/3.0.1/LICENSE */ (function(global, factory) {
...
},{}]},["f65IU","f47v6"], "f47v6", "parcelRequire5647")
